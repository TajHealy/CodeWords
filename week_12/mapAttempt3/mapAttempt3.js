...
//var typesize = (map(typesize,300,1800,50,200));
//var spacesize = (map(spacesize,10,50,50,100));
//var linesize = (map(linesize,100,200,200,300));
...
var typesize = (map(width,300,1650,50,200));
  ...
  for (var w=0; w<words.length;w++){ 
     if (wx+textWidth(words[w])<=width-margin){
        points1 = font.textToPoints(words[w], wx*multiplier, wy+50, typesize, 0.9);
